...
public class TestObjects {
    ...
    public static final Comparator<int[]> intArrayComparer = new Comparator<int[]>(){
        @Override
    ...
    public static TestObject<int[]> intArray = new TestObject<int[]>(new int[]{5432,124,41,1234,653,-562,976}, intArrayComparer);
    public static TestObject<VSAuction> auction = new TestObject<VSAuction>(new VSAuction("some fancy name", 542), auctionComparer);
